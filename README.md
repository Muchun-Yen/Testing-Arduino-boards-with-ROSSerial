...
1.Check your test enviroment (all example for Ubuntu14.04LTS & ROS Indigo)
	...
	1.4 create ROS package (ex.mega2560_test)
		ex:http://wiki.ros.org/ROS/Tutorials/CreatingPackage 
	1.5 cooking launch file
...
4 Multi-board test launch
	4.1. Create python files
		~/catkin_ws/src/rosserial/rosserial_python/nodes/serial_node.py
		~/catkin_ws/src/rosserial/rosserial_python/nodes/serial_node1.py
		
	4.2.modified the test launch
		$ test2boards.launch
==========
<?xml version="1.0"?>
